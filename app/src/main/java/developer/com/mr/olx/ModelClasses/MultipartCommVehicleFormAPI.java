...
public class MultipartCommVehicleFormAPI {
    ...
    public MultipartCommVehicleFormAPI(Context context) {
    ...
    public void uploadFormDataFormAPI(int vehicle_inventory_id, int user_id, String v_title, double v_price,
                                      ...
                                      File file9,
                                      File file10,
                                      int v_type_id, String brand, double kms, String year_of_registration,
                                      int c_insurance, String i_description, int v_show_mo_no, String v_description, String v_location,
        ...
        MultipartBody.Part fileToUpload2 = MultipartBody.Part.createFormData("v_picture_link_2", file2.getName(), mFile2);
        MultipartBody.Part fileToUpload3 = MultipartBody.Part.createFormData("v_picture_link_3", file3.getName(), mFile3);
        MultipartBody.Part fileToUpload4 = MultipartBody.Part.createFormData("v_picture_link_4", file4.getName(), mFile4);
        MultipartBody.Part fileToUpload5 = MultipartBody.Part.createFormData("v_picture_link_5", file5.getName(), mFile5);
        MultipartBody.Part fileToUpload6 = MultipartBody.Part.createFormData("v_picture_link_6", file6.getName(), mFile6);
        MultipartBody.Part fileToUpload7 = MultipartBody.Part.createFormData("v_picture_link_7", file7.getName(), mFile7);
        MultipartBody.Part fileToUpload8 = MultipartBody.Part.createFormData("v_picture_link_8", file8.getName(), mFile8);
        MultipartBody.Part fileToUpload9 = MultipartBody.Part.createFormData("v_picture_link_9", file9.getName(), mFile9);
        MultipartBody.Part fileToUpload10 = MultipartBody.Part.createFormData("v_picture_link_10", file10.getName(), mFile10);

        RequestBody vehicle_inventory_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(vehicle_inventory_id));

        RequestBody user_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(user_id));

        RequestBody v_title_body = RequestBody.create(MultipartBody.FORM, v_title);

        RequestBody v_price_body = RequestBody.create(MultipartBody.FORM, String.valueOf(v_price));

        RequestBody v_type_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(v_type_id));

        RequestBody brand_body = RequestBody.create(MultipartBody.FORM, brand);

        RequestBody kms_body = RequestBody.create(MultipartBody.FORM, String.valueOf(kms));
        ...
        RequestBody c_show_mo_no_body = RequestBody.create(MultipartBody.FORM, String.valueOf(v_show_mo_no));
        ...
        Call<ClsInventoryMasterFormData> callPlaceOrder =
                interfacePlaceOrder.postCommVehicleFormAPI(vehicle_inventory_id_body, user_id_body, v_title_body, v_price_body,
                        fileToUpload1,
                        fileToUpload2,
                        fileToUpload3,
                        fileToUpload4,
                        ...
                        fileToUpload9,
                        fileToUpload10,
                        v_type_id_body, brand_body, kms_body, year_of_registration_body,
