...
public class MultipartOfficeFormAPI {
    ...
    public MultipartOfficeFormAPI(Context context) {
    ...
    public void uploadFormDataFormAPI(int office_inventory_id, int user_id, String o_title, int p_type_id, String p_name,
                                      int cabin, int washroom, double o_sq_ft, double o_price,
                                      File file1,
                                      File file2,
                                      File file3,
                                      File file4,
                                      ...
                                      double o_sup_builtup_area, double o_carpet_area, int p_listed_by_id, double employee_capacity, double o_maintenance,
                                      int j_show_mo_no, String j_description,
        ...
        MultipartBody.Part fileToUpload1 = MultipartBody.Part.createFormData("o_picture_link_1", file1.getName(), mFile1);
        MultipartBody.Part fileToUpload2 = MultipartBody.Part.createFormData("o_picture_link_2", file2.getName(), mFile2);
        MultipartBody.Part fileToUpload3 = MultipartBody.Part.createFormData("o_picture_link_3", file3.getName(), mFile3);
        MultipartBody.Part fileToUpload4 = MultipartBody.Part.createFormData("o_picture_link_4", file4.getName(), mFile4);
        MultipartBody.Part fileToUpload5 = MultipartBody.Part.createFormData("o_picture_link_5", file5.getName(), mFile5);
        MultipartBody.Part fileToUpload6 = MultipartBody.Part.createFormData("o_picture_link_6", file6.getName(), mFile6);
        MultipartBody.Part fileToUpload7 = MultipartBody.Part.createFormData("o_picture_link_7", file7.getName(), mFile7);
        MultipartBody.Part fileToUpload8 = MultipartBody.Part.createFormData("o_picture_link_8", file8.getName(), mFile8);
        MultipartBody.Part fileToUpload9 = MultipartBody.Part.createFormData("o_picture_link_9", file9.getName(), mFile9);
        MultipartBody.Part fileToUpload10 = MultipartBody.Part.createFormData("o_picture_link_10", file10.getName(), mFile10);

        RequestBody office_inventory_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(office_inventory_id));

        RequestBody user_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(user_id));

        RequestBody o_title_body = RequestBody.create(MultipartBody.FORM, o_title);
        ...
        RequestBody cabin_body = RequestBody.create(MultipartBody.FORM, String.valueOf(cabin));

        RequestBody washroom_body = RequestBody.create(MultipartBody.FORM, String.valueOf(washroom));

        RequestBody o_sq_ft_body = RequestBody.create(MultipartBody.FORM, String.valueOf(o_sq_ft));

        RequestBody o_price_body = RequestBody.create(MultipartBody.FORM, String.valueOf(o_price));
        ...
        RequestBody o_sup_builtup_area_body = RequestBody.create(MultipartBody.FORM, String.valueOf(o_sup_builtup_area));

        RequestBody o_carpet_area_body = RequestBody.create(MultipartBody.FORM, String.valueOf(o_carpet_area));

        RequestBody p_listed_by_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(p_listed_by_id));

        RequestBody employee_capacity_body = RequestBody.create(MultipartBody.FORM, String.valueOf(employee_capacity));

        RequestBody o_maintenance_body = RequestBody.create(MultipartBody.FORM, String.valueOf(o_maintenance));
        ...
        Call<ClsInventoryMasterFormData> callPlaceOrder =
                interfacePlaceOrder.postOfficeFormAPI(office_inventory_id_body, user_id_body, o_title_body, p_type_id_body, p_name_body, cabin_body, washroom_body,
                        o_sq_ft_body, o_price_body,
                        fileToUpload1,
                        fileToUpload2,
                        fileToUpload3,
                        fileToUpload4,
                        ...
                        fileToUpload9,
                        fileToUpload10,
                        p_furnishing_id_body, p_car_parking_id_body, o_sup_builtup_area_body, o_carpet_area_body, p_listed_by_id_body, employee_capacity_body,
                        o_maintenance_body, j_show_mo_no_body, j_description_body,
