...
public class MultipartPropertyRentFormAPI {
    ...
    public MultipartPropertyRentFormAPI(Context context) {
    ...
    public void uploadFormDataFormAPI(int property_inventory_id, int user_id, String p_title, int p_type_id, String p_name, int p_bedroom, int p_bathroom,
                                      ...
                                      double p_sup_builtup_area, double p_carpet_area, int p_listed_by_id, int p_preferred_renters_id,
        ...
        RequestBody p_preferred_renters_id_body = RequestBody.create(MultipartBody.FORM, String.valueOf(p_preferred_renters_id));
        ...
        Call<ClsInventoryMasterFormData> callPlaceOrder =
                interfacePlaceOrder.postPropertyRentFormAPI(property_inventory_id_body, user_id_body, p_title_body, p_type_id_body, p_name_body,
                        ...
                        p_preferred_renters_id_body, p_maintenance_body, c_show_mo_no_body, description_body,
