...
import developer.com.mr.olx.ModelClasses.BikeScooterFormAPI;
...
public class BikeScooterFormActivity extends AppCompatActivity {
    String sub_title = "";
    TextView txt_title;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bikes_scooter_form);
        ...
        iv_add_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listPhoto.size() != 0 && listPhoto.size() > 10) {
                    ClsGlobal.errorMsg(BikeScooterFormActivity.this, v, "Select at least 10 photo...!");
                    return;
                }
                ClsGlobal.OnImageSelection(BikeScooterFormActivity.this, REQUEST_CODE_CHOOSE);
            }
        });

        mAdapter = new UriAdapter(BikeScooterFormActivity.this, listPhoto);
        ...
        btn_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validation(view)) {
                    ...
                    Toast.makeText(BikeScooterFormActivity.this, "Fill required value...!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    void BikeScooterFormAPI() {
        ...
        ClsBikeScooter mObj = new ClsBikeScooter();
        ...
        apiPostViewModel.FillBikeScooterForm(mObj).observe(this, obj -> {
            if (obj != null) {
...
//                    listPhoto.add(new clsPhoto((long) i3, selectedPhotos.get(i3)));
    ...
    void saveMultipleImages() {
        ...
        pd = ClsGlobal._prProgressDialog(BikeScooterFormActivity.this,
                "please wait for upload images...!", false);
        pd.show();
        for (int i3 = 0; i3 < this.listPhoto.size(); i3++) {
            bmpArray.add(listPhoto.get(i3).getmBitmap());
        }
        ClsGlobal.storeMultipleImage(BikeScooterFormActivity.this, bmpArray);
    }
    ...
    void uploadMultipleImageAPI(File mFile1, File mFile2, File mFile3, File mFile4, File mFile5,
        ...
        BikeScooterFormAPI multipleImageUploader = new BikeScooterFormAPI(BikeScooterFormActivity.this);
        multipleImageUploader.uploadFormDataFormAPI(0, 1, edt_title.getText().toString(), Double.parseDouble(edt_price.getText().toString()),
                ...
                edt_brand.getText().toString(), Integer.parseInt(edt_kms.getText().toString()), Integer.parseInt(edt_year.getText().toString()),
        ...
        multipleImageUploader.SetCallBack(new BikeScooterFormAPI.FileUploaderCallback() {
            @Override
            public void onError() {
                if (pd.isShowing()) {
                    pd.dismiss();
            ...
            public void onFinish(ClsInventoryMasterFormData responses) {
                if (responses.getSuccess() == 1) {
                    ...
                    ClsGlobal.deleteMultipleImagesFromFolder(BikeScooterFormActivity.this);
                }
            }
