...
import developer.com.mr.olx.userMaster.UserProfileViewModel;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_empty_dracula);
        iv_set_img.setImageBitmap(bitmap);
        ...
        btn_save.setOnClickListener(view -> {
            getAddProductInfo(ClsGlobal.getStringFile(new File(selectedImagePath)));
        });
...
//      mObj.setProfilePictureBase64url("data:image/png;base64,");
        ...
        Log.d("--pro--", "onResponse: " + new Gson().toJson(mObj));

        userProfileViewModel.insertUserInfo(mObj).observe(this, obj -> {
            if (obj != null) {
                try {
                    int message = obj.getSuccess();
                    Log.e("--pro--", "message: " + message);
                    if (message != 1) {
                        Log.e("--pro--", "IF != 1");
                        Toast.makeText(getApplicationContext(), "Failed to upload user info...!", Toast.LENGTH_SHORT).show();
                    } else {
                        Log.e("--pro--", "ELSE_SUCCESS");
                        Toast.makeText(EditProfileActivity.this, "Your user info is add successfully...!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Log.e("--pro--", "Exception: " + e.getMessage());
                }
                pd.dismiss();
            }
        });
        ...
        if (requestCode == REQUEST_CODE_CHOOSE && resultCode == RESULT_OK) {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                for (int i3 = 0; i3 < this.selectedPhotos.size(); i3++) {
                    selectedImagePath = selectedPhotos.get(i3);
                    Glide.with(this)
                            .load(BitmapFactory.decodeFile(selectedPhotos.get(i3))).apply((BaseRequestOptions<?>)
                            new RequestOptions()).thumbnail(0.1f).into(iv_set_img);
                    Log.d("--pro--", "selectedImagePath: " + selectedImagePath);
                    Log.d("--pro--", "selectedImagePath: " + BitmapFactory.decodeFile(selectedPhotos.get(i3)));
                }
            }
        }
    }
