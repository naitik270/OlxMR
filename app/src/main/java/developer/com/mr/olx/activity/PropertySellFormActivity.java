...
import developer.com.mr.olx.ModelClasses.MultipartPropertySellFormAPI;
...
public class PropertySellFormActivity extends AppCompatActivity {
    String sub_title = "";
    TextView txt_title;
    ...
    TextView txt_title1;
    TextView txt_title2;
    LinearLayout ll_preferred_renters;
    ...
    Bitmap bitmap9;
    Bitmap bitmap10;
    EditText edt_carpet_area;
    Button btn_post;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sell_property_form);
        ...
        ll_preferred_renters = findViewById(R.id.ll_preferred_renters);
        ...
        iv_add_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listPhoto.size() != 0 && listPhoto.size() > 10) {
                    ClsGlobal.errorMsg(PropertySellFormActivity.this, v, "Select at least 10 photo...!");
                    return;
                }
                ClsGlobal.OnImageSelection(PropertySellFormActivity.this, REQUEST_CODE_CHOOSE);
            }
        });

        mAdapter = new UriAdapter(PropertySellFormActivity.this, listPhoto);
        ...
        if (sub_title != null) {
            if (sub_title.equalsIgnoreCase("Rent Property")) {
                ll_preferred_renters.setVisibility(View.VISIBLE);
                ll_emp_capacity.setVisibility(View.GONE);
                txt_title1.setText("Bedroom");
                ll_status.setVisibility(View.VISIBLE);
                txt_title2.setText("Bathroom");
            } else if (sub_title.equalsIgnoreCase("Sell Property")) {
                ll_preferred_renters.setVisibility(View.GONE);
                ll_emp_capacity.setVisibility(View.GONE);
                ll_status.setVisibility(View.VISIBLE);
                txt_title1.setText("Bedroom");
                txt_title2.setText("Bathroom");
            } else if (sub_title.equalsIgnoreCase("Sell Office") ||
                    sub_title.equalsIgnoreCase("Rent Office")) {
                ll_preferred_renters.setVisibility(View.GONE);
                ll_emp_capacity.setVisibility(View.VISIBLE);
                ll_status.setVisibility(View.GONE);
                txt_title1.setText("Cabin");
                txt_title2.setText("Washroom");
            }
        }
        ...
        btn_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validation(view)) {
                    ...
                    Toast.makeText(PropertySellFormActivity.this, "Fill required value...!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    void selectCarTypeDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PropertySellFormActivity.this);
    ...
    void selectStatusDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PropertySellFormActivity.this);
        List<String> lstTypeName = new ArrayList<>();
        lstTypeName.add("New launch");
        lstTypeName.add("Ready to move");
        lstTypeName.add("Under construction");

        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this,
                R.layout.row_dialog_label, lstTypeName);

        builder.setAdapter(dataAdapter, (dialog, which) -> {
            txt_status.setText(lstTypeName.get(which));
            txt_status.setTag(which);
        });
        AlertDialog dialog = builder.create();
        dialog.show();
    }
...
//        mObj.setMoPictureLink3(baseUrlDemo);
        ...
        mObj.setpStatus(txt_status.getText().toString());
        ...
        apiPostViewModel.FillSellPropertyForm(mObj).observe(this, obj -> {
            if (obj != null) {
...
//                    listPhoto.add(new clsPhoto((long) i3, selectedPhotos.get(i3)));
    ...
    void saveMultipleImages() {
        ...
        pd = ClsGlobal._prProgressDialog(PropertySellFormActivity.this,
                "please wait for upload images...!", false);
        pd.show();
        for (int i3 = 0; i3 < this.listPhoto.size(); i3++) {
            bmpArray.add(listPhoto.get(i3).getmBitmap());
        }
        ClsGlobal.storeMultipleImage(PropertySellFormActivity.this, bmpArray);
    }
    ...
    void uploadMultipleImageAPI(File mFile1, File mFile2, File mFile3, File mFile4, File mFile5,
        ...
        MultipartPropertySellFormAPI multipleImageUploader = new MultipartPropertySellFormAPI(PropertySellFormActivity.this);
        multipleImageUploader.uploadFormDataFormAPI(0,
                ...
                Integer.parseInt(txt_status.getTag().toString()),
        ...
        multipleImageUploader.SetCallBack(new MultipartPropertySellFormAPI.FileUploaderCallback() {
            @Override
            public void onError() {
                if (pd.isShowing()) {
                    pd.dismiss();
            ...
            public void onFinish(ClsInventoryMasterFormData responses) {
                if (responses.getSuccess() == 1) {
                    ...
                    ClsGlobal.deleteMultipleImagesFromFolder(PropertySellFormActivity.this);
                }
            }
