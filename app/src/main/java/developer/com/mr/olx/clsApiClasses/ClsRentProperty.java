...
public class ClsRentProperty implements Serializable {
    ...
    @SerializedName("p_preferred_renters_id")
    @Expose
    private Integer pPreferredRentersId;
    ...
    public Integer getpPreferredRentersId() {
        return pPreferredRentersId;
    }

    public void setpPreferredRentersId(Integer pPreferredRentersId) {
        this.pPreferredRentersId = pPreferredRentersId;
    }
